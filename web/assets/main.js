...
d3.csv('assets/summary.csv', function(data) {

  var yAxis = 'Baumdichte', xAxis = 'Miete';
  var yAxisOptions = ["Baumdichte", "Erholungsflächen", "Übergewichtige Kinder", "Kinder pro Kita", "Kitaplätze", "Familien mit Kindern", "Einwohner über 65", "Durchschnittsalter",  "Waldflächen", "Wasserflächen", "Verkehrsflächen", "Ärzte", "Sozialleistungen"]
  // var yAxisOptions = ["Well-being"];
  var descriptions = {
      "Baumdichte" : "Bäume pro km²",
    "Übergewichtige Kinder" : "2012 eingeschulte übergewichtige und adipöse Kinder (%)",
    "Kinder pro Kita" : "Kinder pro Kita (2012)",
    "Kitaplätze" : "genehmigte Kitaplätze pro 1000 Einwohner (2012)",
    "Einwohner über 65" : "Prozentualer Anteil an Einwohnern über 65 (2012)",
    "Familien mit Kindern" : "Familien mit Kindern (%; 2012)",
    "Durchschnittsalter" : "Durchschnittsalter (2012)",
    "Waldflächen" : "Prozentualer Anteil an Waldflächen (2012)",
    "Erholungsflächen" : "Prozentualer Anteil an Erholungsflächen (2012)",
    "Wasserflächen" : "Prozentualer Anteil an Wasserflächen (2012)",
    "Verkehrsflächen" : "Prozentualer Anteil an Verkehrsflächen (2012)",
    "Ärzte" : "Niedergelassene Kassenärzte pro 1000 Einwohner (2012)",
    "Sozialleistungen" : "Bedarfsorientierte Sozialleistungen pro 1000 Einwohner (2012)"
  };
